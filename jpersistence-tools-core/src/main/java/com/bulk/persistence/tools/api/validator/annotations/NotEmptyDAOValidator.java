...
@Documented
@Inherited
@DAOConstraint(validatedBy = NotEmptyDAOValidatorRule.class)
public @interface NotEmptyDAOValidator {
	 ...
	 * @return	Message
	 */
	public String message() default "com.bulk.persistence.tools.api.validator.annotations.notemptydaovalidator.fail";
