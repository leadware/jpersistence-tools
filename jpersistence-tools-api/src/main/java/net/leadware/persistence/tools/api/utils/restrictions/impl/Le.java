...
/**
 * Classe représentant un predicat de le
 * @author <a href="mailto:jetune@yahoo.fr">Jean-Jacques ETUNE NGI</a>
 * @since 26 avr. 2013 : 08:30:19
 */
public class Le<Y extends Comparable<? super Y>> extends AbstractPredicate {
	 ...
	 */
	public Le(String property, Y value) {
	...
	public Predicate generateJPAPredicate(CriteriaBuilder criteriaBuilder, Root<?> root) {
		...
		return criteriaBuilder.lessThanOrEqualTo(this.<Y>buildPropertyPath(root, property), value);
	}
}
