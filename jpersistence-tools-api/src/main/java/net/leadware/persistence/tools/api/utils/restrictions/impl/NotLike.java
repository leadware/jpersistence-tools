...
/**
 * Classe représentant un predicat de notLike
 * @author <a href="mailto:jetune@yahoo.fr">Jean-Jacques ETUNE NGI</a>
 * @since 26 avr. 2013 : 08:30:19
 */
public class NotLike extends AbstractPredicate {
	 ...
	 */
	public NotLike(String property, String value) {
	...
	public Predicate generateJPAPredicate(CriteriaBuilder criteriaBuilder, Root<?> root) {
		...
		return criteriaBuilder.notLike(this.<String>buildPropertyPath(root, property), value);
	}
}
