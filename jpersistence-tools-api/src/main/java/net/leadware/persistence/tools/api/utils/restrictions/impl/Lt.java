...
/**
 * Classe représentant un predicat de lt
 * @author <a href="mailto:jetune@yahoo.fr">Jean-Jacques ETUNE NGI</a>
 * @since 26 avr. 2013 : 08:30:19
 */
public class Lt<Y extends Comparable<? super Y>> extends AbstractPredicate {
	 ...
	 */
	public Lt(String property, Y value) {
	...
	public Predicate generateJPAPredicate(CriteriaBuilder criteriaBuilder, Root<?> root) {
		...
		return criteriaBuilder.lessThan(this.<Y>buildPropertyPath(root, property), value);
	}
}
