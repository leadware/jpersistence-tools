...
import com.bulk.persistence.tools.api.validator.MappedValidatorRule;
...
public @interface NotEmptyDAOValidator {
	 ...
	 * @return	Message
	 */
	public String message() default "com.bulk.persistence.tools.api.validator.base.annotations.notemptydaovalidator.fail";
