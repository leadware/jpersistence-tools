 ...
 * 
 */
package com.yashiro.persistence.utils.dao.tools.encrypter;
...
import com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.InvalidAlgorithmKeyException;
import com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.InvalidBlockSizeException;
import com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.InvalidKeySpecificationException;
...
public class Encrypter {
	...
	public Encrypter(){
		...
		try {
			...
			throw new com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.NoSuchAlgorithmException(e);
			
		} catch (NoSuchPaddingException e) {
			
			// On relance l'exception
			throw new com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.NoSuchPaddingException(e);
	...
	public synchronized String decryptText(String text) {
		...
		try {
			...
			// On relance l'exception
			throw new com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.BadPaddingException(e);
			
		} catch (IOException e) {
			
			// On relance l'exception
			throw new com.yashiro.persistence.utils.dao.tools.encrypter.exceptions.IOException(e);
